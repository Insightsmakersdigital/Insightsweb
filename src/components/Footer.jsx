        ...
        <div className="flex flex-col items-center">
          ...
          <div className="text-center relative">
            <p className="text-gray-300 text-sm">
              © {new Date().getFullYear()} All Rights Reserved by <span className="bg-gradient-to-r from-[#5eead4] to-[#5eead4]/70 bg-clip-text text-transparent font-medium">Insights Makers</span>
            </p>
          </div>
        </div>
      </div>
